...
const ProductCardItem = ({ product, editable = false, user, purchased }) => {
	...
	return (
		product && (
			...
			<div>
				<div className="w-full relative rounded-3xl overflow-hidden max-w-md mx-auto bg-gradient-to-r from-[#1D2235] to-[#121318] p-5 md:my-10 my-3">
					<Rays />
					<Beams />
					<div className="relative z-10">
						...
						>
							...
							<p className="text-neutral-200 text-left  mt-4">
								The all new apple vision pro was the best thing
								that happened around 8 months ago, not anymore.
							</p>
						</motion.div>
					</div>
				</div>
